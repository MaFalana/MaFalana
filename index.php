...
<head>
  ...
  <title>
    Malik Falana | A Web Developer based in Indianapolis, Indiana.
  </title>
    ...
    <div class="header__text-box row">
      <div class="header__text">
        <h1 class="heading-primary">
          ...
          <span>Malik Falana</span>
        </h1>
        <!-- Put a small paragraph about yourself -->
        <p>A Web Developer based in Indianapolis, Indiana.</p>
        ...
        <div class="work__boxes">
          ...
          <div class="work__box">
            <div class="work__text">
              <h3>LEDGERº</h3>
              <p>
                Open source manga reading application for IOS/iPadOS.
              </p>
              <ul class="work__list">
                <li>Swift</li>
              </ul>
              ...
              <div class="work__links">
                <a href="https://testflight.apple.com/join/947cRtnp" target="_blank" class="link__text">
                  Visit Site <span>&rarr;</span>
                </a>
                <a href="https://github.com/MaFalana/LEDGER-" title="View Source Code" target="_blank">
          ...
          <div class="work__box">
            <div class="work__text">
              ...
              <div class="work__links">
                ...
                <a href="https://github.com/MaFalana/CS-Paint" title="View Source Code" target="_blank">
          ...
          <div class="work__box">
            <div class="work__text">
              <h3>What's That Color?</h3>
              <p>
                Color Scanner/Palette Generator application for IOS.
              </p>
              <ul class="work__list">
                <li>Swift</li>
              </ul>
              ...
              <div class="work__links">
                ...
                <a href="https://github.com/MaFalana/What-s-That-Color-" title="View Source Code" target="_blank">
                  <img src="./images/github.svg" class="work__code" title="View Source Code" alt="GitHub">
                </a>
              </div>
            </div>
    ...
    <div class="row">
      ...
      <div class="contact__info">
        ...
        <form  action="index.php" method="post">
          ...
          <input name="enter" class="emailSubmit" type="submit" value="Send"/>
  ...
  <footer role="contentinfo" class="footer">
    <div class="row">
      ...
      <ul class="footer__social-links">
        ...
        <li class="footer__social-link-item">
          <a href="https://github.com/MaFalana" title="Link to Github Profile">
